...
export default class Login extends Component {
    ...
    componentDidMount = async () => {
        ...
        try {
            ...
            const currentAddress ="0x48792cE5b14e3862C9a6674d1045249965f975fB";
                ...
                <div className="bodyC">
                    ...
                    <div className="auth-wrapper">
                        <div className="auth-inner">
                            ...
                            <Button href="#" disabled={!this.state.seller} className="btn-block" style={{margin: "2px", backgroundColor: "peru"}} >Seller Dashboard</Button>
                            <br/><Button href="#" disabled={!this.state.buyer} className="btn-block" style={{margin: "2px", backgroundColor: "peru"}}>Buyer Dashboard</Button>
                            <br/><Button href="#" disabled={!this.state.landInspector} className="btn-block" style={{margin: "2px", backgroundColor: "peru"}}>Land Inspector Dashboard</Button>
                        </div>
                    </div>
                </div>
            );
